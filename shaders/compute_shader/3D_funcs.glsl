...
vec4 update_velocity_euler_texture(sampler3D tex, vec4 l_pos, vec4 stepsize, bool using_data2)
{
  // Left slope
...
// Unsteady Euler
vec4 update_velocity_euler_texture_refined(sampler3D tex0, sampler3D tex1, vec4 pos, float h, float rel_dt, float curr_time, float vector_factor, vec4 cell_factor)
{
  // Left slope
...
// Steady Euler
vec4 update_velocity_euler_texture_refined(sampler3D tex, vec4 pos, float h, float vector_factor, vec4 cell_factor)
{
  // Left slope
...
vec4 update_velocity_rk4_texture(sampler3D tex, vec4 y0, vec4 stepsize, bool using_data2)
{
...
// Unsteady RK4
vec4 update_velocity_rk4_texture_refined(sampler3D tex0, sampler3D tex1, vec4 pos, float h, float rel_dt, float curr_time, float vector_factor, vec4 cell_factor)
{
...
// Steady RK4
vec4 update_velocity_rk4_texture_refined(sampler3D tex, vec4 pos, float h, float vector_factor, vec4 cell_factor)
{
  vec4 k1 = texture_velo(tex, pos, false) * vector_factor * cell_factor;
  vec4 k2 = texture_velo(tex, pos + h * k1/2.0, false) * vector_factor * cell_factor;
  vec4 k3 = texture_velo(tex, pos + h * k2/2.0, false) * vector_factor * cell_factor;
  vec4 k4 = texture_velo(tex, pos + h * k3, false) * vector_factor * cell_factor;
...
// ==========
// Improved Euler Scheme
vec4 update_velocity_euler_texel(sampler3D tex, vec4 l_pos, vec4 stepsize, bool using_data2)
{
  // Left slope
...
// Unsteady Euler
vec4 update_velocity_euler_texel_refined(sampler3D tex0, sampler3D tex1, vec4 pos, float h, float rel_dt, float curr_time, float vector_factor, vec4 cell_factor)
{
  // Left slope
...
// Steady Euler
vec4 update_velocity_euler_texel_refined(sampler3D tex, vec4 pos, float h, float vector_factor, vec4 cell_factor)
{
  // Left slope
...
// Runge Kutta 4th order
vec4 update_velocity_rk4_texel(sampler3D tex, vec4 y0, vec4 stepsize, bool using_data2)
{
...
// Unsteady RK4
vec4 update_velocity_rk4_texel_refined(sampler3D tex0, sampler3D tex1, vec4 pos, float h, float rel_dt, float curr_time, float vector_factor, vec4 cell_factor)
{
...
// Steady RK4
vec4 update_velocity_rk4_texel_refined(sampler3D tex, vec4 pos, float h, float vector_factor, vec4 cell_factor)
{
